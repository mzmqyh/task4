...
public class ThirdPageController {
    ...
    @RequestMapping(value = "task4/task-91",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "task4/task-92",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "task4/task-93", method = RequestMethod.GET)
